...
DROP TABLE IF EXISTS `queues`.`customers`;
CREATE TABLE `queues`.`customers` (
  ...
  CONSTRAINT `service_fk` FOREIGN KEY (`service`) REFERENCES `queues`.`services` (`id`)
...
DROP TABLE IF EXISTS `queues`.`services`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `queues`.`services` (
...
LOCK TABLES `queues`.`services` WRITE;
/*!40000 ALTER TABLE `services` DISABLE KEYS */;
INSERT INTO `queues`.`services` VALUES (1,'Housing'),(2,'Benifits'),(3,'Fly-tipping'),(4,'Missed Bin');
